package com.sabquiz.roomimpl

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import androidx.lifecycle.lifecycleScope
import com.sabquiz.roomimpl.data.db.SchoolDatabase
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val students = listOf(
            ...
            Student("Mark Sukerberg",5,"Jake Wharton School"),
        ...
        val studentSubjectRelations = listOf(
            ...
            StudentSubjectCrossRef("Mark Sukerberg", "Dating for programmers"),
...
//            schoolWithDirector.first().school
